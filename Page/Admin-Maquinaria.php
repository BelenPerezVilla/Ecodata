...
<html lang="es">
    <head>
        ...
        <title>Ecodata -  Admin Maquinaria</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navegador Brand-->
            <a class="navbar-brand ps-3" href="Admin.php" >Maquinaria</a>
            <!-- Sidebar Toggle-->
                    ...
                    <tbody>
                            ...
                            $sql=$conexion->query("SELECT * FROM Maquinaria $where");
                                ...
                                <th><?=$datos->IdMaquinaria?></th>
                                        ...
                                        <th><?=$datos->Nota?></th>
                                    <td>
                                    <a href="MMaquinaria-A.php?id=<?=$datos->IdMaquinaria?>"><i class="fa-regular fa-keyboard"></i></a>
                                        <a href="Eliminar_Maquinaria-A.php?id=<?=$datos->IdMaquinaria?>"><i class="fa-sharp fa-regular fa-circle-xmark"></i></a>
                                    </td>
                                </tr>     
                        <?php
                        }
