...
<html lang="es">
    <head>
        ...
        <title>Ecodata - Detalle Compra</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="Administracion-contable.php">Detalle Compra</a>
            <!-- Sidebar Toggle-->
    ...
    if (isset($_GET['enviar'])) {
        ...
        if (!empty($buscar)) {
            $where = "WHERE IdDetalleCompra LIKE '%$buscar%'";
        }
    }
    ?>
</form>
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        ...
                        <?php
                      include "conexion.php";
                      include "Controladores/Registro/Registro_DetalleCompra.php";
                    ?>                        
                        
                        <section class="form-register">
                        <h4>Registro</h4>
                            <input class="controls" type="hidden" name="IdDetalleCompra" id="IdDetalleCompra" placeholder="ID detalle compra" readonly>
                            ...
                            <input class="controls" type="number" name="MontoCompra" id="MontoCompra" placeholder="Ingrese monto de compra">
                            <button class="botons" type="submit" name="btmRegistrarDC" value="Ok">Registrar</button>
                        ...
                        <br>
                            ...
                            <thead>
                                <tr>
                                <th scope="col">IdDetalleCompra</th>
                                    <th scope="col">IdProveedor</th>
                                    <th scope="col">IdCompra</th>
                                    <th scope="col">MontoCompra</th>
                    ...
                    <tbody>
                            ...
                            <?php
                            include "conexion.php";
                            $sql=$conexion->query("SELECT * FROM DetalleCompra $where");
                                while($datos=$sql->fetch_object()){?>
                                <tr>
                                <th><?=$datos->IdDetalleCompra?></th>
                                        <th><?=$datos->IdProveedor?></th>
                                        <th><?=$datos->IdCompra?></th>
                                        <th><?=$datos->MontoCompra?></th>
                                    <td>
