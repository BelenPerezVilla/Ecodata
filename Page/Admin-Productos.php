...
<html lang="es">
    <head>
        ...
        <title>Ecodata -  Admin Productos</title>
...
ini_set('display_errors', 1);
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navegador Brand-->
            <a class="navbar-brand ps-3" href="Admin.php" >Productos</a>
            <!-- Sidebar Toggle-->
                    ...
                    <tbody>
                            ...
                            $sql=$conexion->query("SELECT * FROM Producto $where");
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href="MProductos-A.php?id=<?=$datos->IdProducto?>"><i class="fa-regular fa-keyboard"></i></a>
                                        <a href="Eliminar_Producto-A.php?id=<?=$datos->IdProducto?>"><i class="fa-sharp fa-regular fa-circle-xmark"></i></a>
                                    </td>
                                </tr>     
                        <?php
                        }
