...
<html lang="es">
    <head>
        ...
        <title>Ecodata -  Admin Mantenimiento</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navegador Brand-->
            <a class="navbar-brand ps-3" href="Admin.php" >Mantenimiento</a>
            <!-- Sidebar Toggle-->
                    ...
                    <tbody>
                            ...
                            $sql=$conexion->query("SELECT * FROM Mantenimiento $where");
                                ...
                                <th><?=$datos->IdMantenimiento?></th>
                                    ...
                                    <td>
                                    <a href="MMantenimiento-A.php?id=<?=$datos->IdMantenimiento?>"><i class="fa-regular fa-keyboard"></i></a>
                                        <a href="Eliminar_Mantenimiento-A.php?id=<?=$datos->IdMantenimiento?>"><i class="fa-sharp fa-regular fa-circle-xmark"></i></a>
                                    </td>
                                </tr>     
                        <?php
                        }
