...
<html lang="en">
    <head>
        ...
        <title>Ecodata - Control Calidad</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="ProductosEspecificaciones.php">Control Calidad</a>
            <!-- Sidebar Toggle-->
    ...
    if (isset($_GET['enviar'])) {
        ...
        if (!empty($buscar)) {
            $where = "WHERE IdAreaControlCalidad LIKE '%$buscar%'";
        }
    }
    ?>
</form>
            ...
            <main>
                    <div class="container-fluid px-4">
                        ...
                        <br>
                            ...
                            <thead>
                                <tr>
                                <th scope="col">IdAreaControlCalidad</th>
                    ...
                    <tbody>
                            ...
                            <?php
                            include "conexion.php";
                            $sql=$conexion->query("SELECT * FROM ControlCalidad $where");
                                while($datos=$sql->fetch_object()){?>
                                <tr>
                                <th><?=$datos->IdAreaControlCalidad?></th>
                                        <th><?=$datos->Nombre?></th>
                                        <th><?=$datos->Descripcion?></th>
                                        <th><?=$datos->Objetivo?></th>
                                        <th><?=$datos->Alcance?></th>
                                        <th><?=$datos->Responsable?></th>
                                        <th><?=$datos->Metodologia?></th>
                                    <td>
                                    <a href="MControlCalidad.php?id=<?=$datos->IdAreaControlCalidad?>"><i class="fa-regular fa-keyboard"></i></a>
                                        </td>
                                </tr>     
                        <?php
                        }
