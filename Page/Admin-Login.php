...
<html lang="en">
    <head>
        ...
        <title>Ecodata -  Admin Login</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navegador Brand-->
            <a class="navbar-brand ps-3" href="Admin.php" >Login</a>
            <!-- Sidebar Toggle-->
    ...
    if (isset($_GET['enviar'])) {
        ...
        if (!empty($buscar)) {
            $where = "WHERE InicioLog.IdUsuario LIKE '%" . $buscar . "%' OR InicioLog.IdArea LIKE '%" . $buscar . "%' OR InicioLog.Usuario LIKE '%" . $buscar . "%' OR InicioLog.Contraseña LIKE '%" . $buscar . "%'";
        }
    }
    ?>
</form>
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <?php
                      include "conexion.php";
                      include "Controladores/Registro/Registro_login.php";
                    ?>                        
                        
                        <section class="form-register">
                        <h4>Registro</h4>
                        <input class="controls" type="number" name="IdUsuario" id="IdUsuario" placeholder="Ingrese ID del usuario">
                            <input class="controls" type="number" name="IdArea" id="IdArea" placeholder="Ingrese ID del area">
                            <input class="controls" type="text" name="Usuario" id="Usuario" placeholder="Ingrese nombre de usuario">
                            <input class="controls" type="text" name="Contraseña" id="Contraseña" placeholder="Ingrese contraseña">              
                            <input class="botons" type="submit" name ="btmRegistrarL" value="Registrar"> <br>
                            <button class="botons" type="button"  onclick="location.href='fpdf/RLogin.php'">Imprimir pdf</button>
                    ...
                    <tbody>
                            ...
                            <?php
                            include "conexion.php";
                            $sql=$conexion->query("SELECT * FROM InicioLog $where");
                                ...
                                <th><?=$datos->IdUsuario?></th>
                                        ...
                                        <td>
                                        <a href="MLogin-A.php?id=<?=$datos->IdUsuario?>"><i class="fa-regular fa-keyboard"></i></a>
                                        <a href="Eliminar_Login-A.php?id=<?=$datos->IdUsuario?>"><i class="fa-sharp fa-regular fa-circle-xmark"></i></a>
                                        <a href="fpdf/RLogin_ID.php?id=<?=$datos->IdUsuario?>"><i class="fa-solid fa-print"></i></a>
                                    </td>
                                </tr>     
                        <?php
                        }
