...
<html lang="es">
    <head>
        ...
        <title>Ecodata -  Admin Control Calidad</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navegador Brand-->
            <a class="navbar-brand ps-3" href="Admin.php" >Control Calidad</a>
            <!-- Sidebar Toggle-->
                    ...
                    <tbody>
                            ...
                            $sql=$conexion->query("SELECT * FROM ControlCalidad $where");
                                ...
                                <th><?=$datos->IdAreaControlCalidad?></th>
                                    ...
                                    <td>
                                    <a href="MControlCalidad-A.php?id=<?=$datos->IdAreaControlCalidad?>"><i class="fa-regular fa-keyboard"></i></a>
                                        </td>
                                </tr>     
                        <?php
                        }
