...
<html lang="es">
    <head>
        ...
        <title>Ecodata -  Admin Proveedores</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navegador Brand-->
            <a class="navbar-brand ps-3" href="Admin.php" >Proveedores</a>
            <!-- Sidebar Toggle-->
                    ...
                    <tbody>
                            ...
                            $sql=$conexion->query("SELECT * FROM Proveedor $where");
                                ...
                                <th><?=$datos->IDProveedor?></th>
                                    ...
                                    <td>
                                    <a href="MProveedor-A.php?id=<?=$datos->IDProveedor?>"><i class="fa-regular fa-keyboard"></i></a>
                                        <a href="Eliminar_Proveedor-A.php?id=<?=$datos->IDProveedor?>"><i class="fa-sharp fa-regular fa-circle-xmark"></i></a>
                                    </td>
                                </tr>     
                        <?php
                        }
