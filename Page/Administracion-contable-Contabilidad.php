...
<html lang="es">
    <head>
        ...
        <title>Ecodata - Contabilidad</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="Administracion-contable.php">Contabilidad</a>
            <!-- Sidebar Toggle-->
    ...
    if (isset($_GET['enviar'])) {
        ...
        if (!empty($buscar)) {
            $where = "WHERE IdAreaContabilidad LIKE '%$buscar%'";
        }
    }
    ?>
</form>
            ...
            <main>
                    <div class="container-fluid px-4">
                        ...
                        <br>
                            ...
                            <thead>
                                <tr>
                                <th scope="col">IdAreaContabilidad</th>
                                    <th scope="col">Nombre</th>
                                    <th scope="col">RegimenFiscal</th>
                                    <th scope="col">FechaInicio</th>
                                    <th scope="col">Moneda</th>
                                    <th scope="col">CierreFiscal</th>
                    ...
                    <tbody>
                            ...
                            <?php
                            include "conexion.php";
                            $sql=$conexion->query("SELECT * FROM Contabilidad $where");
                                while($datos=$sql->fetch_object()){?>
                                <tr>
                                <th><?=$datos->IdAreaContabilidad?></th>
                                        <th><?=$datos->Nombre?></th>
                                        <th><?=$datos->RegimenFiscal?></th>
                                        <th><?=$datos->FechaInicio?></th>
                                        <th><?=$datos->Moneda?></th>
                                        <th><?=$datos->CierreFiscal?></th>
                                    <td>
                                    <a href="MContabilidad.php?id=<?=$datos->IdAreaContabilidad?>"><i class="fa-regular fa-keyboard"></i></a>
