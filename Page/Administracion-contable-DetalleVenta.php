...
<html lang="es">
    <head>
        ...
        <title>Ecodata - Detalle Ventas</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="Administracion-contable.php">Detalle Ventas</a>
            <!-- Sidebar Toggle-->
    ...
    if (isset($_GET['enviar'])) {
        ...
        if (!empty($buscar)) {
            $where = "WHERE IdDetalleVenta LIKE '%$buscar%'";
        }
    }
    ?>
</form>
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        ...
                        <?php
                    include "conexion.php";
                    include "Controladores/Registro/Registro_DVenta.php";
                    ?>                        
                        
                        <section class="form-register">
                        <h4>Registro</h4>
                            <input class="controls" type="hidden" name="IdDetalleVenta" id="IdDetalleVenta" placeholder="ID del detalle de venta" readonly>
                            ...
                            <button class="botons" type="submit" name="btmRegistrarDV" value="Ok">Registrar</button>
                          </section>
                        </form>
                        ...
                        <br>
                            ...
                            <thead>
                                <tr>
                                <th scope="col">IdDetalleVenta</th>
                    ...
                    <tbody>
                            ...
                            <?php
                            include "conexion.php";
                            $sql=$conexion->query("SELECT * FROM DetalleVenta $where");
                                while($datos=$sql->fetch_object()){?>
                                <tr>
                                <th><?=$datos->IdDetalleVenta?></th>
                                        <th><?=$datos->IdVentas?></th>
                                        <th><?=$datos->IdPedido?></th>
                                    <td>
                                    <a href="MDVentas.php?id=<?=$datos->IdDetalleVenta?>"><i class="fa-regular fa-keyboard"></i></a>
                                        <a href="Eliminar_DetalleVentas.php?id=<?=$datos->IdDetalleVenta?>"><i class="fa-sharp fa-regular fa-circle-xmark"></i></a>
                                    </td>
                                </tr>     
                        <?php
                        }
