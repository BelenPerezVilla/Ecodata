...
if (!empty($_GET['id'])) {
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Cell(90);
            // Título
            $this->Cell(70,10,utf8_decode('Reporte Embarques de ID:') . $id,0,0,'C');
            // Salto de línea
            $this->Ln(20);
    ...
    if (isset($_GET['id'])) {
        ...
        $consulta = "SELECT * FROM Embarques WHERE IdAEmbarques = ?";
