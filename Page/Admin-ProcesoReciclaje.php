...
<html lang="en">
    <head>
        ...
        <title>Ecodata -  Admin Proceso Reciclaje</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navegador Brand-->
            <a class="navbar-brand ps-3" href="Admin.php" >Proceso Reciclaje</a>
            <!-- Sidebar Toggle-->
                                    ...
                                    <tbody>
                                        ...
                                        while ($datos = $sql->fetch_object()) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="MProcesoReciclaje-A.php?id=<?= $datos->IdProceso ?>"><i class="fa-regular fa-keyboard"></i></a>
                                                    <a href="Eliminar_ProcesoReciclaje-A.php?id=<?= $datos->IdProceso ?>"><i class="fa-sharp fa-regular fa-circle-xmark"></i></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
