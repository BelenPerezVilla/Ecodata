...
<html lang="es">
    <head>
        ...
        <title>Ecodata -  Admin Detalle Venta</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navegador Brand-->
            <a class="navbar-brand ps-3" href="Admin.php" >Detalle Venta</a>
            <!-- Sidebar Toggle-->
                    ...
                    <tbody>
                            ...
                            $sql=$conexion->query("SELECT * FROM DetalleVenta $where");
                                ...
                                <th><?=$datos->IdDetalleVenta?></th>
                                    ...
                                    <td>
                                    <a href="MDVentas-A.php?id=<?=$datos->IdDetalleVenta?>"><i class="fa-regular fa-keyboard"></i></a>
                                        <a href="Eliminar_DetalleVentas-A.php?id=<?=$datos->IdDetalleVenta?>"><i class="fa-sharp fa-regular fa-circle-xmark"></i></a>
                                    </td>
                                </tr>     
                        <?php
                        }
