...
<html lang="en">
    <head>
        ...
        <title>Ecodata -  Admin Compra</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navegador Brand-->
            <a class="navbar-brand ps-3" href="Admin.php" >Compra</a>
            <!-- Sidebar Toggle-->
    ...
    if (isset($_GET['enviar'])) {
        ...
        if (!empty($buscar)) {
            $where = "WHERE IdCompra LIKE '%$buscar%'";
        }
    }
    ?>
</form>
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        ...
                        <?php
                      include "conexion.php";
                      include "Controladores/Registro/Registro_Compra.php";
                    ?>                        
                        
                        <section class="form-register">
                        <h4>Registro</h4>
                            <input class="controls" type="hidden" name="IdCompra" id="IdCompra" placeholder="ID de la compra" readonly>
                            ...
                            <input class="controls" type="date" name="FechaCompra" id="FechaCompra" placeholder="Seleccione fecha de compra">
                            <input class="controls" type="number" name="Cantidad" id="Cantidad" placeholder="Ingrese precio cantidad">
                            <input class="controls" type="number" name="PrecioUnitario" id="PrecioUnitario" placeholder="Ingrese precio unitario">
                            <input class="controls" type="number" name="Total" id="Total" placeholder="Ingrese precio total">
                            <input class="controls" type="text" name="Descripcion" id="Descripcion" placeholder="Ingrese Descripcion">
                            <button class="botons" type="submit" name="btmRegistrarCompra" value="Ok">Registrar</button>
                            <button class="botons" type="button"  onclick="location.href='fpdf/RCompra.php'">Imprimir pdf</button>
                    ...
                    <tbody>
                            ...
                            <?php
                            include "conexion.php";
                            $sql=$conexion->query("SELECT * FROM Compra $where");
                                while($datos=$sql->fetch_object()){?>
                                <tr>
                                <th><?=$datos->IdCompra?></th>
                                        <th><?=$datos->IdProveedor?></th>
                                        <th><?=$datos->IdFierro?></th>
                                        <th><?=$datos->FechaCompra?></th>
                                        <th><?=$datos->Cantidad?></th>
                                        <th><?=$datos->PrecioUnitario?></th>
                                        <th><?=$datos->Total?></th>
                                        <th><?=$datos->Descripcion?></th>
                                    <td>
                                    <a href="MCompra-A.php?id=<?=$datos->IdCompra?>"><i class="fa-regular fa-keyboard"></i></a>
                                        <a href="Eliminar_Compra-A.php?id=<?=$datos->IdCompra?>"><i class="fa-sharp fa-regular fa-circle-xmark"></i></a>
                                        <a href="fpdf/RCompra_ID.php?id=<?=$datos->IdCompra?>"><i class="fa-solid fa-print"></i></a>
