...
<html lang="es">
    <head>
        ...
        <title>Ecodata -  Admin Factura</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navegador Brand-->
            <a class="navbar-brand ps-3" href="Admin.php" >Factura </a>
            <!-- Sidebar Toggle-->
    ...
    if (isset($_GET['enviar'])) {
        ...
        if (!empty($buscar)) {
            $where = "WHERE IdFactura LIKE '%$buscar%'";
        }
    }
    ?>
</form>
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        ...
                        <?php
                      include "conexion.php";
                      include "Controladores/Registro/Registro_Factura.php";
                    ?>                        
                        
                        <section class="form-register">
                        <h4>Registro</h4>
                            <input class="controls" type="hidden" name="IdFactura" id="IdFactura" placeholder="ID de la factura" readonly>
                            <input class="controls" type="text" name="Tipo" id="Tipo" placeholder="Ingrese tipo de factura">
                            <input class="controls" type="text" name="RFC" id="RFC" placeholder="Ingrese el RFC">
                            <h20>Fecha de emisión</h20>
                            <input class="controls" type="date" name="FechaEmision" id="FechaEmision" placeholder="Seleccione fecha de emisión">
                            <h20>Fecha de vencimiento de factura</h20>
                            <input class="controls" type="date" name="VencimientoFactura" id="VencimientoFactura" placeholder="Seleccione fecha de vencimiento">
                            <input class="controls" type="text" name="EstadoFactura" id="EstadoFactura" placeholder="Ingrese estado de la factura">
                            <input class="controls" type="number" name="IdVentas" id="IdVentas" placeholder="Ingrese ID de la venta">
                            ...
                            <button class="botons" type="submit" name="btmRegistrarF" value="oK">Registrar</button>
                            <button class="botons" type="button"  onclick="location.href='fpdf/RFactura.php'">Imprimir pdf</button>
                        ...
                        <br>
                            ...
                            <thead>
                                ...
                                <th scope="col">IdFactura</th>
                                    ...
                                    <th scope="col">VencimientoFactura</th>
                                    <th scope="col">EstadoFactura</th>
                    ...
                    <tbody>
                            ...
                            <?php
                            include "conexion.php";
                            $sql=$conexion->query("SELECT * FROM Factura $where");
                                while($datos=$sql->fetch_object()){?>
                                <tr>
                                <th><?=$datos->IdFactura?></th>
                                        <th><?=$datos->Tipo?></th>
                                        <th><?=$datos->RFC?></th>
                                        <th><?=$datos->FechaEmision?></th>
                                        <th><?=$datos->VencimientoFactura?></th>
                                        <th><?=$datos->EstadoFactura?></th>
                                        <th><?=$datos->IdVentas?></th>
                                        <th><?=$datos->IdCompra?></th>
                                        <th><?=$datos->IdClientes?></th>
                                    <td>
                                    <a href="MFactura-A.php?id=<?=$datos->IdFactura?>"><i class="fa-regular fa-keyboard"></i></a>
                                        <a href="Eliminar_Factura-A.php?id=<?=$datos->IdFactura?>"><i class="fa-sharp fa-regular fa-circle-xmark"></i></a>
                                        <a href="fpdf/RFactura_ID.php?id=<?=$datos->IdFactura?>"><i class="fa-solid fa-print"></i></a>
