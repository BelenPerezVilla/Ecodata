...
<html lang="en">
    <head>
        ...
        <title>Ecodata -  Admin Personal</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navegador Brand-->
            <a class="navbar-brand ps-3" href="Admin.php" >Personal</a>
            <!-- Sidebar Toggle-->
    ...
    if (isset($_GET['enviar'])) {
        ...
        if (!empty($buscar)) {
            $where = "WHERE IdPersonal LIKE '%$buscar%'";
        }
    }
    ?>
</form>
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        ...
                        <?php
                      include "conexion.php";
                      include "Controladores/Registro/Registro_personal.php";
                    ?>                        
                        
                        <section class="form-register">
                        <h4>Registro</h4>
                            <input class="controls" type="hidden" name="id" id="id"  placeholder="ID del personal" readonly>
                            ...
                            <input class="controls" type="date" name="FechaNacimiento" id="FechaNacimiento"  placeholder="Seleccione fecha nacimiento">
                            ...
                            <input class="controls" type="email" name="CorreoElectronico" id="CorreoElectronico"  placeholder="Ingrese su correo correo electronico">       
                    ...
                    <tbody>
                            ...
                            <?php
                            include "conexion.php";
                            $sql=$conexion->query("SELECT * FROM Personal $where");
                                while($datos=$sql->fetch_object()){?>
                                <tr>
                                <th><?=$datos->IdPersonal?></th>
                                        <th><?=$datos->Nombre?></th>
                                    ...
                                    <td>
                                    <a href="MPersonal-A.php?id=<?=$datos->IdPersonal?>"><i class="fa-regular fa-keyboard"></i></a>
                                        <a href="Eliminar_personal-A.php?id=<?=$datos->IdPersonal?>"><i class="fa-sharp fa-regular fa-circle-xmark"></i></a>
                                    </td>
                                </tr>     
                        <?php
                        }
