...
<html lang="en">
    <head>
        ...
        <title>Ecodata - Productos fierro</title>
...
ini_set('display_errors', 1);
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="ProductosEspecificaciones.php">Productos fierro</a>
            <!-- Sidebar Toggle-->
                    ...
                    <tbody>
                            ...
                            $sql=$conexion->query("SELECT * FROM ProductoFierro $where");
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href="MProductoF.php?id=<?=$datos->IdFierro?>"><i class="fa-regular fa-keyboard"></i></a>
                                        <a href="Eliminar_ProductoFierro.php?id=<?=$datos->IdFierro?>"><i class="fa-sharp fa-regular fa-circle-xmark"></i></a>
                                    </td>
                                </tr>     
                        <?php
                        }
