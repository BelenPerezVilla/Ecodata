...
<html lang="es">
    <head>
        ...
        <title>Ecodata -  Admin Pedido</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navegador Brand-->
            <a class="navbar-brand ps-3" href="Admin.php" >Pedido </a>
            <!-- Sidebar Toggle-->
                    ...
                    <tbody>
                            ...
                            $sql=$conexion->query("SELECT * FROM Pedido $where");
                                ...
                                <th><?=$datos->IdPedido?></th>
                                        ...
                                        <th><?=$datos->Estado?></th>
                                    <td>
                                        <a href="MPedido-A.php?id=<?=$datos->IdPedido?>"><i class="fa-regular fa-keyboard"></i></a>
                                        <a href="Eliminar_Pedido-A.php?id=<?=$datos->IdPedido?>"><i class="fa-sharp fa-regular fa-circle-xmark"></i></a>
                                    </td>
                                </tr>     
                        <?php
                        }
