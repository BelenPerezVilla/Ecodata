...
<html lang="es">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="Administracion-contable.php">Compra</a>
            <!-- Sidebar Toggle-->
                    ...
                    <tbody>
                            ...
                            $sql=$conexion->query("SELECT * FROM Compra $where");
                                ...
                                <th><?=$datos->IdCompra?></th>
                                    ...
                                    <td>
                                    <a href="MCompra.php?id=<?=$datos->IdCompra?>"><i class="fa-regular fa-keyboard"></i></a>
                                        <a href="Eliminar_Compra.php?id=<?=$datos->IdCompra?>"><i class="fa-sharp fa-regular fa-circle-xmark"></i></a>
