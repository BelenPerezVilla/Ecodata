...
<html lang="es">
    <head>
        ...
        <title>Ecodata -  Admin Almacen</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navegador Brand-->
            <a class="navbar-brand ps-3" href="Admin.php" >Almacen</a>
            <!-- Sidebar Toggle-->
    ...
    if (isset($_GET['enviar'])) {
        ...
        if (!empty($buscar)) {
            $where = "WHERE Almacen.NombreAlmacen LIKE '%$buscar%' OR Almacen.Encargado LIKE '%$buscar%' OR Almacen.TipoAlmacen LIKE '%$buscar%' OR Almacen.Capacidad LIKE '%$buscar%' OR Almacen.Ubicacion LIKE '%$buscar%' OR Almacen.Secciones LIKE '%$buscar%' OR Almacen.Pasillos LIKE '%$buscar%' OR Almacen.Area LIKE '%$buscar%'" ;
        }
                        ...
                        <div name="tabla" class="card mb-4">
                            ...
                            <div class="card-body">
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            <th scope="col">IdAreaAlmacen</th>
                                            <th scope="col">NombreAlmacen</th>
                                            <th scope="col">Encargado</th>
                                            <th scope="col">TipoAlmacen</th>
                                    ...
                                    <tbody>
                                        <?php
                                        include "conexion.php";
                                        $sql = $conexion->query("SELECT * FROM Almacen $where ");
                                        while ($datos = $sql->fetch_object()) { ?>
                                            <tr>
                                                <th><?= $datos->IdAreaAlmacen ?></th>
                                                <th><?= $datos->NombreAlmacen ?></th>
                                                <th><?= $datos->Encargado ?></th>
                                                <th><?= $datos->TipoAlmacen ?></th>
                                                <th><?= $datos->Capacidad ?></th>
                                                <th><?= $datos->Ubicacion ?></th>
                                                <th><?= $datos->Secciones ?></th>
                                                <th><?= $datos->Pasillos ?></th>
                                                <th><?= $datos->Area ?></th>
                                                <td>
                                                    <a href="MAlmacen-A.php?id=<?= $datos->IdAreaAlmacen ?>"><i class="fa-regular fa-keyboard"></i></a>
                                                    <a href="fpdf/RAlmacen.php?id=<?=$datos->IdAreaAlmacen?>"><i class="fa-solid fa-print"></i></a>
