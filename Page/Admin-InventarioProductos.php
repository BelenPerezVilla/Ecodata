...
<html lang="es">
    <head>
        ...
        <title>Ecodata -  Admin Inventario Productos</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navegador Brand-->
            <a class="navbar-brand ps-3" href="Admin.php" >Inventario Productos</a>
            <!-- Sidebar Toggle-->
                    ...
                    <tbody>
                            ...
                            $sql=$conexion->query("SELECT * FROM InventarioProductos $where");
                                ...
                                <th><?=$datos->IdInventarioP?></th>
                                    ...
                                    <td>
                                    <a href="MInventarioProductos-A.php?id=<?=$datos->IdInventarioP?>"><i class="fa-regular fa-keyboard"></i></a>
                                        <a href="Eliminar_InventarioProductos-A.php?id=<?=$datos->IdInventarioP?>"><i class="fa-sharp fa-regular fa-circle-xmark"></i></a>
                                    </td>
                                </tr>     
                        <?php
                        }
