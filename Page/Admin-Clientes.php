...
<html lang="en">
    <head>
        ...
        <title>Ecodata -  Admin Clientes</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navegador Brand-->
            <a class="navbar-brand ps-3" href="Admin.php" >Clientes</a>
            <!-- Sidebar Toggle-->
    ...
    if (isset($_GET['enviar'])) {
        ...
        if (!empty($buscar)) {
            $where = "WHERE IdClientes LIKE '%$buscar%'";
        }
    }
    ?>
</form>
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        ...
                        <?php
                      include "conexion.php";
                      include "Controladores/Registro/Registro_Cliente.php";
                    ?>                        
                        
                        <section class="form-register">
                        <h4>Registro</h4>
                            <input class="controls" type="hidden" name="IdClientes" id="IdClientes" placeholder="ID del cliente" readonly>
                            ...
                            <input class="controls" type="tel" name="Contacto" id="Contacto" placeholder="Ingrese su contacto">       
                            <input class="controls" type="email" name="Email" id="Email" placeholder="Ingrese su correo correo electronico">       
                            <button class="botons" type="submit" name="btmRegistrarClientes" value="Ok">Registrar</button>
                    ...
                    <tbody>
                            ...
                            <?php
                            include "conexion.php";
                            $sql=$conexion->query("SELECT * FROM Clientes $where");
                                ...
                                <th><?=$datos->IdClientes?></th>
                                        ...
                                        <th><?=$datos->Email?></th>
                                        <td>
                                        <a href="MCliente-A.php?id=<?=$datos->IdClientes?>"><i class="fa-regular fa-keyboard"></i></a>
                                        <a href="Eliminar_Clientes-A.php?id=<?=$datos->IdClientes?>"><i class="fa-sharp fa-regular fa-circle-xmark"></i></a>
                                    </td>
                                </tr>     
                        <?php
                        }
