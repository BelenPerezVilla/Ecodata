...
<html lang="es">
    <head>
        ...
        <title>Ecodata -  Admin Embarques</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navegador Brand-->
            <a class="navbar-brand ps-3" href="Admin.php" >Embarques</a>
            <!-- Sidebar Toggle-->
                    ...
                    <tbody>
                            ...
                            $sql=$conexion->query("SELECT * FROM Embarques $where");
                                ...
                                <th><?=$datos->IdAEmbarques?></th>
                                    ...
                                    <td>
                                    <a href="MEmbarques-A.php?id=<?=$datos->IdAEmbarques?>"><i class="fa-regular fa-keyboard"></i></a>
                                        <a href="Eliminar_Embarques-A.php?id=<?=$datos->IdAEmbarques?>"><i class="fa-sharp fa-regular fa-circle-xmark"></i></a>
