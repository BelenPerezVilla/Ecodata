...
<html lang="en">
    <head>
        ...
        <title>Ecodata -  Admin Contabilidad</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navegador Brand-->
            <a class="navbar-brand ps-3" href="Admin.php" >Contabilidad</a>
            <!-- Sidebar Toggle-->
                    ...
                    <tbody>
                            ...
                            $sql=$conexion->query("SELECT * FROM Contabilidad $where");
                                ...
                                <th><?=$datos->IdAreaContabilidad?></th>
                                    ...
                                    <td>
                                    <a href="MContabilidad-A.php?id=<?=$datos->IdAreaContabilidad?>"><i class="fa-regular fa-keyboard"></i></a>
