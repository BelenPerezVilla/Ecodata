...
<html lang="es">
    <head>
        ...
        <title>Ecodata -  Admin Ventas</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navegador Brand-->
            <a class="navbar-brand ps-3" href="Admin.php" >Ventas</a>
            <!-- Sidebar Toggle-->
                    ...
                    <tbody>
                            ...
                            $sql=$conexion->query("SELECT * FROM Ventas $where");
                                ...
                                <th><?=$datos->IdVentas?></th>
                                    ...
                                    <td>
                                    <a href="MVentas-A.php?id=<?=$datos->IdVentas?>"><i class="fa-regular fa-keyboard"></i></a>
                                        <a href="Eliminar_Ventas-A.php?id=<?=$datos->IdVentas?>"><i class="fa-sharp fa-regular fa-circle-xmark"></i></a>
