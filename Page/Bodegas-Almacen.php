...
<html lang="es">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3"  href="Bodegas.php">Almacen</a>
            <!-- Sidebar Toggle-->
                            ...
                            <div class="card-body">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = $conexion->query("SELECT * FROM Almacen");
                                        while ($datos = $sql->fetch_object()) { ?>
                                            <tr>
                                                ...
                                                <th><?= $datos->Area ?></th>
                                                <td>
                                                    <a href="MAlmacen.php?id=<?= $datos->IdAreaAlmacen ?>"><i class="fa-regular fa-keyboard"></i></a>
                                                </td>
                                            </tr>     
                                        <?php } ?>
                                    </tbody>
