...
<html lang="es">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="Administracion-contable.php">Pedido</a>
            <!-- Sidebar Toggle-->
    ...
    if (isset($_GET['enviar'])) {
        ...
        if (!empty($buscar)) {
            $where = "WHERE IdPedido LIKE '%$buscar%'";
        }
    }
    ?>
</form>
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        ...
                        <?php
                      include "conexion.php";
                      include "Controladores/Registro/Registro_Pedido.php";
                    ?>                        
                        
                        <section class="form-register">
                        <h4>Registro</h4>
                            <input class="controls" type="hidden" name="IdPedido" id="IdPedido" placeholder="ID del pedido" readonly>
                            <h20>Fecha del pedido</h20>
                            <input class="controls" type="date" name="FechaPedido" id="FechaPedido" placeholder="Seleccione fecha del pedido">
                            <input class="controls" type="text" name="Producto" id="Producto" placeholder="Ingrese nombre del producto">
                            <input class="controls" type="number" name="Cantidad" id="Cantidad" placeholder="Ingrese cantidad">
                            <input class="controls" type="text" name="Estado" id="Estado" placeholder="Ingrese estado del pedido">       
                            <button class="botons" type="submit" name="btmRegistrarPedido" value="Ok">Registrar</button>
                    ...
                    <tbody>
                            ...
                            <?php
                            include "conexion.php";
                            $sql=$conexion->query("SELECT * FROM Pedido $where");
                                ...
                                <th><?=$datos->IdPedido?></th>
                                        ...
                                        <th><?=$datos->Estado?></th>
                                    <td>
                                        <a href="MPedido.php?id=<?=$datos->IdPedido?>"><i class="fa-regular fa-keyboard"></i></a>
                                        <a href="Eliminar_Pedido.php?id=<?=$datos->IdPedido?>"><i class="fa-sharp fa-regular fa-circle-xmark"></i></a>
                                    </td>
                                </tr>     
                        <?php
                        }
