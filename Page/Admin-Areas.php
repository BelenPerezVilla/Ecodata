...
<html lang="en">
    <head>
        ...
        <title>Ecodata -  Admin Areas</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navegador Brand-->
            <a class="navbar-brand ps-3" href="Admin.php" >Areas</a>
            <!-- Sidebar Toggle-->
    ...
    if (isset($_GET['enviar'])) {
        ...
        if (!empty($buscar)) {
            $where = "WHERE Tipo LIKE '%$buscar%' OR IdArea LIKE '%$buscar%'";
        }
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        ...
                        <?php
                      include "conexion.php";
                      include "Controladores/Registro/Registro_Areas.php";
                    ?>                        
                        
                        <section class="form-register">
                        <h4>Registro</h4>
                           
                            <input class="controls" type="text" name="Tipo" id="Tipo" placeholder="Ingrese tipo de area">
                            <button class="botons" type="submit" name="btmRegistrarA" value="Ok">Registrar</button>
                            <button class="botons" type="button"  onclick="location.href='fpdf/RAreas.php'">Imprimir pdf</button>
                    ...
                    <tbody>
                            ...
                            <?php
                            include "conexion.php";
                            $sql=$conexion->query("SELECT * FROM Areas  $where");
                                while($datos=$sql->fetch_object()){?>
                                <tr>
                                <th><?=$datos->IdArea?></th>
                                        <th><?=$datos->Tipo?></th>
                                    <td>
                                    <a href="MAreas-A.php?id=<?=$datos->IdArea?>"><i class="fa-regular fa-keyboard"></i></a>
                                        <a href="Eliminar_Areas-A.php?id=<?=$datos->IdArea?>"><i class="fa-sharp fa-regular fa-circle-xmark"></i></a>
                                        <a href="fpdf/RAreas_ID.php?id=<?=$datos->IdArea?>"><i class="fa-solid fa-print"></i></a>
