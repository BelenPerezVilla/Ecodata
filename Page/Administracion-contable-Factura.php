...
<html lang="es">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="Administracion-contable.php">Factura</a>
            <!-- Sidebar Toggle-->
            ...
            <main>
                    ...
                    ?>                        
                        ...
                        <h4>Registro</h4>
                            ...
                            <input class="botons" type="submit" name="btmRegistrarF" value="Registrar">
                    ...
                    <tbody>
                            ...
                            $sql=$conexion->query("SELECT * FROM Factura $where");
                                ...
                                <th><?=$datos->IdFactura?></th>
                                    ...
                                    <td>
                                    <a href="MFactura.php?id=<?=$datos->IdFactura?>"><i class="fa-regular fa-keyboard"></i></a>
                                        <a href="Eliminar_Factura.php?id=<?=$datos->IdFactura?>"><i class="fa-sharp fa-regular fa-circle-xmark"></i></a>
                                    </td>
                                </tr>     
                        <?php
                        }
