...
<html lang="en">
    <head>
        ...
        <title>Ecodata -  Admin Produccion </title>
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navegador Brand-->
            <a class="navbar-brand ps-3" href="Admin.php" >Produccion</a>
            <!-- Sidebar Toggle-->
                                    ...
                                    <tbody>
                                        ...
                                        while($datos=$sql->fetch_object()){ ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="MProduccion-A.php?id=<?=$datos->IdPro?>"><i class="fa-regular fa-keyboard"></i></a>
                                                    <a href="Eliminar_Produccion-A.php?id=<?=$datos->IdPro?>"><i class="fa-sharp fa-regular fa-circle-xmark"></i></a>
